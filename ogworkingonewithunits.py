...
class WeatherPredictionApp:
    def __init__(self, master):
        ...
        self.scaler = None
        self.features = []
        self.entries = {}  # To store user input entries
    ...
    def create_input_fields(self):
        ...
        for feature in self.features:
            ...
            # Display the unit of measurement next to the input field
            unit_label = ttk.Label(frame, text=f"{units.get(feature, '')}", font=("Arial", 12), background='white')
