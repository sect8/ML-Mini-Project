...
# Target: Binary classification of weather (Snow = 1, No Snow = 0)
# We will classify if the weather is "snow" or not
data['is_snow'] = data['weather'].apply(lambda x: 1 if x == 'snow' else 0)
y = data['is_snow'].values
...
plt.title('Probability Distribution of Logistic Regression Predictions for Snow')
